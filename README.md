...
<b>limdo</b><br/>
메인 개발<br/>
<sub>웹 전체 설계 및 구현<br/>FastAPI · Next.js · LangGraph</sub><br/><br/>
<sub><i>Django + FastAPI 마이크로서비스 패턴도 고려했지만, RAG DB가 MongoDB Atlas에 있어 유저·세션까지 한곳에 두는 게 낫다고 판단해 FastAPI 단일 서버로 결정했습니다. 덕분에 초기 개발은 빨랐지만, 규모가 커진다면 AI 레이어와 API 레이어 분리는 피할 수 없을 것 같습니다.</i></sub>
</td>
<td align="center" width="33%">
<b>minho8234</b><br/>
AI & 기획<br/>
<sub>테스트 시나리오<br/>랜딩 페이지 기획</sub><br/><br/>
<sub><i>LLM을 연동한 질의응답 웹페이지 개발을 통해 새로운 영역을 배우는 기회가 되었고, 프론트엔드·백엔드를 디테일하게 접해볼 수 있었습니다. 3명이서 짧은 시간 내에 구현하기엔 부족함도 있었지만, 도형님·승준님이 고생해준 덕분에 좋은 결과로 마무리하게 되어 좋습니다.</i></sub>
</td>
<td align="center" width="33%">
<b>fleshflamer-commits</b><br/>
보안 & 기획<br/>
<sub>프롬프트 인젝션 방어 테스트<br/>랜딩 페이지 기획</sub><br/><br/>
<sub><i>코딩 측면에서는 아직 제가 한참 부족하다는 것을 많이 느끼고 있지만, 그래도 이번 기회에 본격적인 프로젝트 작업을 조금이나마 본격적으로 체험해본 것은 가치 있는 경험으로 남을 것 같습니다. 강의 과정에서 배운 장고가 아닌 다른 툴로 과제를 풀어가는 것은 여전히 공부할 게 많다는 것을 새삼 되새기는 계기가 되었습니다. 코딩 외적으로 기획 및 디자인적인 작업 또한 회의 과정에서 다루거나, 깃헙에서 pull request 시 양식을 직접 작성하는 등 사소하지만 기초적인 지식을 배우는 것 또한 좋은 공부가 되었습니다. 풍부한 지식을 바탕으로 친절하게 설명하며 이끌어주신 리더 도형님, 적극적인 의견 제시로 방향성을 다잡아주신 연장자 민호님 덕분에 한걸음 더 나아갈 수 있었습니다. 팀원 여러분께 감사드립니다.</i></sub>
</td>
</tr>
</table>
